...
<div class="form-group col-sm-6" hidden>
    ...
    {!! Form::text('kode', "BL".($belajar + 1), ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('pelajaran', null, ['class' => 'form-control', 'placeholder' => 'Contoh : Berternak Lele']) !!}
</div>
...
<div class="form-group col-sm-6" hidden>
    {!! Form::label('url', 'URL:') !!}
    {!! Form::text('url', $belajar + 1, ['class' => 'form-control']) !!}
</div>
