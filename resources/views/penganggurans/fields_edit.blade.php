...
<div class="form-group col-sm-6" hidden>
    ...
    {!! Form::text('user_id', $pengangguran->user_id, ['class' => 'form-control']) !!}
</div>

<!-- URL Field -->
<div class="form-group col-sm-6" hidden>
    {!! Form::label('url', 'URL:') !!}
    {!! Form::text('url', $pengangguran->url, ['class' => 'form-control']) !!}
</div>

<!-- Submit Field -->
<div class="form-group col-sm-12">
    {!! Form::submit('Edit', ['class' => 'btn btn-primary']) !!}
    <a href="{!! route('penganggurans.index') !!}" class="btn btn-default">Batal</a>
</div>
