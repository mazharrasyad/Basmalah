...
<div class="form-group col-sm-6" hidden>
    ...
    <?php echo Form::text('user_id', $pengangguran->user_id, ['class' => 'form-control']); ?>
...
<div class="form-group col-sm-6" hidden>
    ...
    <?php echo Form::text('url', $pengangguran->url, ['class' => 'form-control']); ?>
...
<div class="form-group col-sm-12">
    ...
    <a href="<?php echo route('penganggurans.index'); ?>" class="btn btn-default">Batal</a>
</div>
