<table class="table table-responsive" id="jadwals-table">
    ...
    <?php $__currentLoopData = $jadwals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jadwal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php if(Auth::user()->id == $jadwal->belajars['user_id']): ?>
        <tr>
            ...
            <td>
              <a href="<?php echo route('jadwals.show', [$jadwal->url]); ?>" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
              <a href="<?php echo route('jadwals.edit', [$jadwal->url]); ?>" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
            </td>
        </tr>
      <?php endif; ?>
