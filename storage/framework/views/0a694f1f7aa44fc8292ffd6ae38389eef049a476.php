...
<div class="register-box">
    <div class="register-logo">
        <a href="<?php echo e(url('/home')); ?>"><b>Daftar </b>User</a>
    </div>

    <div class="register-box-body">

        <form method="post" action="<?php echo e(url('/abcdedaftarabcde')); ?>">

            <?php echo csrf_field(); ?>


            <div class="form-group has-feedback<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                <input type="text" class="form-control" name="name" value="<?php echo e(old('name')); ?>" placeholder="Nama Lengkap">
...
<html lang="en">
    ...
    <body>
        <div class="flex-center position-ref full-height">
            <div class="content">
                <div class="title">
                    <b>Terjadi Kesalahan Pada Halaman Ini</b>
                </div>
            </div>
        </div>
    </body>
