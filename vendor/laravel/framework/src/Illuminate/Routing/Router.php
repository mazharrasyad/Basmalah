...
class Router implements RegistrarContract, BindingRegistrar
{
    ...
    public function auth()
    {
        ...
        // Registration Routes...
        $this->get('abcdedaftarabcde', 'Auth\RegisterController@showRegistrationForm')->name('abcdedaftarabcde');
        $this->post('abcdedaftarabcde', 'Auth\RegisterController@register');
